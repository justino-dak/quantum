...
import Icon from 'sulu-admin-bundle/components/Icon/index';
import {translate} from 'sulu-admin-bundle/utils/index';
import Loader from 'sulu-admin-bundle/components/Loader/Loader';
import Router from 'sulu-admin-bundle/services/Router';
import userStore from 'sulu-admin-bundle/stores/userStore';
import ForgotPasswordForm from 'sulu-admin-bundle/containers/Login/ForgotPasswordForm';

import LoginForm from 'sulu-admin-bundle/containers/Login/LoginForm';
import ResetPasswordForm from 'sulu-admin-bundle/containers/Login/ResetPasswordForm';
import loginStyles from './login.scss';
import TwoFactorForm from 'sulu-admin-bundle/containers/Login/TwoFactorForm';
import type {FormTypes, ForgotPasswordFormData, LoginFormData, ResetPasswordFormData, TwoFactorFormData} from 'sulu-admin-bundle/containers/Login/types';
